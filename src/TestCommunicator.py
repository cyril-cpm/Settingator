...
class TCommunicator(Communicator):
    ...
    def SendInitRequest(self, param) -> None:
    ...
    def GetSettingLayout(self) -> Type[SettingLayout]:
        ...
        #buffer = bytearray([0xff, 0x00, 0x1D, 0x13, 0x02, 0x08, 0x01, 0x42, 0x0C, 0x55, 0x6E, 0x20, 0x53, 0x6C, 0x69, 0x64, 0x65, 0x72, 0x20, 0x42, 0x47, 0x67, 0x02, 0x87, 0x03, 0x2D, 0x5F, 0xB0, 0x00])
        buffer = bytearray([0xff, 0x00, 0x1F, 0x13, 0x02, 0x08, 0x01, 0x01, 0x42, 0x0C, 0x55, 0x6E, 0x20, 0x53, 0x6C, 0x69, 0x64, 0x65, 0x72, 0x20, 0x42, 0x47, 0x67, 0x02, 0x01, 0x87, 0x03, 0x2D, 0x5F, 0xB0, 0x00])
        
        msg = Message(buffer[3])
